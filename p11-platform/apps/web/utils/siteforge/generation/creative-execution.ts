...
const PROFILE_VARIANTS = {
  editorial: {
    ...
    'acf/offering-browser': 'list',
    'acf/entity-directory': 'cards',
    'acf/comparison-table': 'table',
    'acf/timeline': 'vertical',
    'acf/document-library': 'list',
    'acf/events-directory': 'cards',
    'acf/governed-component': 'governed',
  },
  conversion: {
    'acf/menu': 'sticky-cta',
    ...
    'acf/offering-browser': 'cards',
    'acf/entity-directory': 'grouped',
    'acf/comparison-table': 'compact',
    'acf/timeline': 'milestones',
    'acf/document-library': 'cards',
    'acf/events-directory': 'list',
    'acf/governed-component': 'governed',
  },
  immersive: {
    'acf/menu': 'standard',
    ...
    'acf/offering-browser': 'availability',
    'acf/entity-directory': 'map',
    'acf/comparison-table': 'cards',
    'acf/timeline': 'horizontal',
    'acf/document-library': 'grouped',
    'acf/events-directory': 'calendar',
    'acf/governed-component': 'governed',
  },
