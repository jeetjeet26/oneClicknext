-- Reconcile hosted projects that predate the workflow processing lease
-- migration. The lease prevents overlapping processors from dispatching the
-- same workflow action more than once.
